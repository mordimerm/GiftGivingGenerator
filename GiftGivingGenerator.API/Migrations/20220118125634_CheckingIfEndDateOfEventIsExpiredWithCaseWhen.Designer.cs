...
namespace GiftGivingGenerator.API.Migrations
{
    ...
    [Migration("20220118125634_CheckingIfEndDateOfEventIsExpiredWithCaseWhen")]
    partial class CheckingIfEndDateOfEventIsExpiredWithCaseWhen
    {
            ...
            modelBuilder.Entity("GiftGivingGenerator.API.Entities.Event", b =>
                {
                    ...
                    b.Property<bool?>("IsActive")
                        ...
                        .HasColumnType("bit")
                        .HasComputedColumnSql("CASE WHEN EndDate < GETUTCDATE() THEN 'false' ELSE 'true' END");
